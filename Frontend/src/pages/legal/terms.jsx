        ...
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow p-8 space-y-8">
          ...
          <section className="space-y-4 text-slate-700">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                En caso de <strong>errores técnicos, fallos del sistema o
                duplicidad de números</strong>, la empresa se reserva el derecho
                de:
                <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
                  <li>Reasignar un nuevo número de rifa.</li>
                  <li>Realizar la <strong>devolución total del dinero</strong>.</li>
                </ul>
              </li>
              <li>
          ...
          <section className="space-y-4 text-slate-700">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                ...
                <strong> no podrá ser redimido bajo ninguna circunstancia</strong>.
              </li>
              <li>
              ...
              <li>
                Cualquier intento de <strong>fraude, manipulación o uso
                indebido</strong> invalidará automáticamente el beneficio, sin
                derecho a reclamo.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-4 text-slate-700">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                La información personal <strong>no será vendida, cedida ni
                compartida</strong> con terceros sin autorización, salvo cuando
          ...
          <section className="space-y-4 text-slate-700">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                información incorrecta proporcionada por el usuario (por ejemplo,
                un número de contacto erróneo).
              </li>
              <li>
